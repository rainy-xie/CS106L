...
def main():
    ...
    assert files_are_equal(
        "utils/courses_offered.csv", "student_output/courses_offered.csv"), "write_courses_offered test failed 😞"
    assert files_are_equal("utils/courses_not_offered.csv",
                           "student_output/courses_not_offered.csv"), "write_courses_not_offered test failed 😞"
